...
var stateHandlers = {
    startModeIntentHandlers : Alexa.CreateStateHandler(constants.states.START_MODE, {
        ...
        'LaunchRequest' : function () {
            ...
            var message = 'Welcome to the Primordial Radio Test Stream. You can say, play Primordial to begin the stream.';
            var reprompt = 'You can say, play Primordial, to begin.';

            this.response.speak(message).listen(reprompt);
            this.emit(':responseReady');
        },
        'playprimordial' : function () {
        ...
        'AMAZON.HelpIntent' : function () {
            var message = 'Welcome to the Primordial Radio Test stream.  Rocks out for Primordial.';
        ...
        'Unhandled' : function () {
            var message = 'Sorry, I could not understand. Please say, play Primordial, to begin the audio.';
            this.response.speak(message).listen(message);
            this.emit(':responseReady');
        }
    }),
